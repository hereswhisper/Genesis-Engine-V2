...
declare function writeBinaryFile(
  path: string,
  data: ArrayBuffer,
): Promise<void>;
declare function appendBinaryFile(
  path: string,
  data: ArrayBuffer,
): Promise<void>;
...
declare function readBinaryFile(
  path: string,
  options?: FileReaderOptions,
): Promise<ArrayBuffer>;
...
declare function updateOpenedFile(
  id: number,
  event: string,
  data?: any,
): Promise<void>;
...
declare function setPermissions(
  path: string,
...
declare function spawnProcess(
  command: string,
  options?: SpawnedProcessOptions,
): Promise<SpawnedProcess>;
declare function updateSpawnedProcess(
  id: number,
  event: string,
  data?: any,
): Promise<void>;
...
declare function showFolderDialog(
  title?: string,
  options?: FolderDialogOptions,
): Promise<string>;
declare function showSaveDialog(
  title?: string,
...
declare function unsetDraggableRegion(
  DOMElementOrId: string | HTMLElement,
): Promise<{
  success: true;
  message: string;
...
declare function extractDirectory(
  path: string,
  destination: string,
): Promise<void>;
...
declare namespace extensions {
  export {
    broadcast$2 as broadcast,
    dispatch$1 as dispatch,
    getStats$1 as getStats,
  };
}
