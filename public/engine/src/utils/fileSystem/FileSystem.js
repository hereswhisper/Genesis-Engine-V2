          ...
          for (const mod of FileSystem.activeMods) {
            ...
            if (await FileSystem.exists(modPath)) {
              if (cleanPath.match(/\.(json|txt|xml|csv)$/i)) {
                ...
                foundModData = {
                  buffer:
                    await Neutralino.filesystem.readBinaryFile(fullModPath),
                };
              }
              break;
            }
          ...
          if (foundModData) {
            ...
            if (this.responseType === "json") {
              Object.defineProperty(this, "response", {
                value: JSON.parse(foundModData.text),
              });
              ...
              Object.defineProperty(this, "response", {
                value: foundModData.buffer,
              });
            } else {
              Object.defineProperty(this, "responseText", {
                value: foundModData.text,
              });
              Object.defineProperty(this, "response", {
                value: foundModData.text,
              });
            ...
            if (typeof this.onreadystatechange === "function")
              this.onreadystatechange(mockEvent);
